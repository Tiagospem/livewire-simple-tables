    ...
    private function getActionsData(): array
    {
        return collect($this->table->actionBuilder->getActions())
            ->map(fn(Action $action): array => [
                ...
                'isWireNavigate'                  => $action->isWireNavigate(),
                'isDisabled'                      => $action->isDisabled($this->row),
                'isHidden'                        => $action->isHidden($this->row),
                ...
                'themeDropdownOptionIconStyle'    => theme($this->theme, 'dropdown.option_icon'),
                'themeDropdownOptionDividerStyle' => theme($this->theme, 'dropdown.option_divider'),
