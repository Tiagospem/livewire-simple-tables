...
>
    ...
    <input
        ...
        {{ $attributes->merge(['class' => 'block w-full rounded-md bg-white py-1.5 pl-10 pr-3 text-base text-gray-900 border-gray-200 placeholder:text-gray-400 focus:-outline-offset-2 focus:outline-indigo-600 sm:pl-9 sm:text-sm/6']) }}
    />
